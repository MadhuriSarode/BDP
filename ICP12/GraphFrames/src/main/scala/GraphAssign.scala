...
object GraphAssign {
  def main(args: Array[String]) {
    System.setProperty("hadoop.home.dir", "/Users/madhurisarode/Documents/BDP lessons/Workspace/GraphFrames")
    ...
    val trips_df = spark.read
      ...
      .load("Input/201508_trip_data.csv")

    val station_df = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("Input/201508_station_data.csv")
    ...
    stationGraph.vertices.write.csv("/Users/madhurisarode/Documents/BDP lessons/Workspace/GraphFrames/Graphs1/Vertices")
    stationGraph.edges.write.csv("/Users/madhurisarode/Documents/BDP lessons/Workspace/GraphFrames/Graphs1/Edges")
